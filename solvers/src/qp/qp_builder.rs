...
use crate::dtos::OptimizerConfig;
...
impl QPBuilder {
    ...
    pub fn build(self) -> Result<QP, SolverError> {
        ...
        Ok(QP {
            ...
            q_mat: self
                .q_mat
                .ok_or(SolverError::ConfigError("q_mat is required".into()))?,
            q_vec: self
                .q_vec
                .ok_or(SolverError::ConfigError("q_vec is required".into()))?,
            a_mat,
            b_vec,
            g_mat,
            h_vec,
