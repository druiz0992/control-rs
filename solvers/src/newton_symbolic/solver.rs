...
use super::problem_spec::ProblemSpec;
use super::utils;
use crate::SolverError;
use crate::dtos::{
    KktConditionsStatus, LagrangianMultiplier, OptimizerConfig, OptimizerParams, SolverResult,
};
use crate::{Minimizer, RootFinder};
use log::info;
use nalgebra::{DMatrix, DVector};
use std::sync::Arc;
use symbolic_services::symbolic::fasteval::ExprRegistry;
use symbolic_services::symbolic::ports::SymbolicExpr;
use symbolic_services::symbolic::{ExprMatrix, ExprScalar, ExprVector, TryIntoEvalResult};
...
impl NewtonSolverSymbolic {
    ...
    /// solve problem
    pub fn solve(&self, initial_guess: &[f64]) -> Result<SolverResult, SolverError> {
        ...
        for i in 0..max_iters {
            ...
            let delta = jacobian_mat
                .lu()
                .solve(&(-&fx))
                .ok_or(SolverError::Other("Failed to solve linear problem".into()))?;
    ...
    fn solve_ip(&self, initial_guess: &[f64]) -> Result<SolverResult, SolverError> {
