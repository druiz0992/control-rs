...
use symbolic_services::symbolic::{ExprMatrix, ExprRecord, ExprScalar, ExprVector};
...
impl LineSeachConfig {
    ...
    pub fn set_factor(self, factor: f64) -> Result<Self, SolverError> {
    ...
    pub fn set_max_iters(self, max_iters: usize) -> Result<Self, SolverError> {
...
impl OptimizerConfig {
    ...
    pub fn set_tolerance(self, tolerance: f64) -> Result<Self, SolverError> {
